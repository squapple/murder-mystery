...
export const EVIDENCE: EvidenceItem[] = [
  ...
  },
  {
    ...
    detail:
      "박서연 숙소(202호) 베란다 화분 뒤에서 주먹만 한 돌 하나가 발견됐다. 표면에 남은 혈흔을 감식한 결과 피해자 김영훈의 혈액형 및 DNA와 일치했다 — 산책로에 흔한 종류의 돌로, 원래 그 자리에 있던 것이 아니라 누군가 옮겨다 놓은 것으로 보인다. 다만 이 돌이 '왜 하필 박서연의 베란다에' 있게 됐는지는 이 물증만으로는 알 수 없다.",
    revealTiming: "round3_open",
  },
  {
