...
export const CHARACTERS: Record<CharacterId, CharacterSheet> = {
  ...
  "role-lee-hyunwoo": {
    ...
    knownSecrets: [
      "여동생이 김영훈과 결혼했다가 얼마 안 가 세상을 떠났다(자살로 처리됨)는 일을 계속 마음에 담아두고 있다 — 김영훈이 여동생을 괴롭혀 그렇게 됐다고 믿지만, 본인도 이게 심증일 뿐 확정된 사실이 아니라는 건 알고 있다",
  ...
  "role-jeong-mina": {
    ...
    knownSecrets: [
      "김영훈과 과거 연인 관계였고 결혼까지 이야기가 오갔으나, 좋지 않게 끝났다 — 그 과정에서 힘든 일을 겪었다",
