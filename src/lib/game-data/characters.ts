...
// "신발"을 추가했다. 정민아의 "법인카드 비리 목격" 서브플롯은 완전히 삭제하고
...
//
// Phase 41 — 사용자가 시간 간극을 직접 재조정하며 확정: 이현우는 계획적으로
// 살해했다(몸싸움 없음, 다만 그 사실을 플레이어 공개 텍스트에는 명시하지 않는다).
// 박서연의 편의점 외출이 21:05(문자 직후)로 당겨지고 22:15에 회식 복귀 → 계속
// 마시다 23:00에 만취해 정민아의 부축을 받고 귀실(Phase 40의 "편의점 근처에서
// 우연히 마주침"이라는 억지 다리가 필요 없어졌다). 이현우는 22:00에 방으로 돌아와
// 흔적을 지우고, 박서연 방이 잠잠해진 23:30에야 베란다 트릭을 실행한다(Phase 40의
// 21:55 직후 실행보다 훨씬 신중해졌다). CCTV 관련 서술은 전부 삭제하고 "이현우가
// CCTV 드문 곳을 직접 제안했다"로 대체. 그날 밤 비가 내렸다는 설정을 추가해 신발
// 증거 근거를 이슬→빗물로 바꿨고, 박서연의 신발 세척 습관/목격담 설정은 삭제하고
// "비에 젖어서 대충 헹궈냄"으로 단순화했다.
...
export const CHARACTERS: Record<CharacterId, CharacterSheet> = {
  "role-park-seoyeon": {
    ...
    knownSecrets: [
      ...
      "베란다에서 발견된 칼을 자신은 전혀 모른다 — 정민아 손에 이끌려 방으로 돌아온 뒤(23:00경) 취한 채로 바로 잠들어 베란다는 확인하지 않았고, 형사가 보여주기 전까지는 그런 물건이 있는 줄도 몰랐다. 처음 보는 물건이라며 당황하고 억울해한다",
    ],
    ...
    truthBibleFacts: [
      "09:00~17:00 낮 산책로 프로그램에 참가함",
      "19:00 회식 시작",
      "그날 밤 20시부터 자정까지 비가 내림",
      "21:05 김영훈에게 문자를 보냄 (\"팀장님 잠깐 이야기 좀 하시죠\") — 이후 편의점으로 감",
      "21:10경 편의점에서 결제 — 이 외출은 완전히 혼자였고, 정확히 언제 회식 자리로 돌아왔는지 증명해 줄 사람이 없다. 절대 이 외출 자체를 숨기거나 다르게 말하지 않는다(사실 그대로 진술)",
  ...
  "role-lee-hyunwoo": {
    ...
    motiveFull:
      "여동생이 예전에 피해자 김영훈과 결혼했었으나 얼마 안 가 세상을 떠났다(자살로 처리됨). 본인은 김영훈이 여동생을 괴롭혀 그렇게 몰아넣었다고 굳게 믿고 있다 — 사망보험금, 그 이후 김영훈의 유독 빠른 재혼 같은 정황이 근거지만, 객관적으로 확정된 사실은 아니고 본인의 주관적 확신에 가깝다(게임은 진위를 판정하지 않는다). 이번 워크숍 장소·일정을 직접 기획하고 숙소 배정까지 맡은 것도, 김영훈과 가까이 있을 기회를 만들기 위해서였다 — CCTV가 거의 없는 외진 곳을 고른 것도 우연이 아니었다. 김영훈을 전화로 산책로에 불러내 몸싸움 없이 살해했다 — 우발적 충돌이 아니라 계획한 일이었다.",
    ...
    knownSecrets: [
      ...
      "워크숍 장소·일정과 숙소 배정을 자신이 직접 맡아 진행했다는 사실 자체는 숨기지 않는다(누가 물어보면 순순히 인정) — 다만 그 이유(김영훈과 가까이 있고 싶어서, CCTV가 드문 곳이라서)는 절대 스스로 밝히지 않는다. 이 장소를 왜 골랐냐고 캐물으면 처음엔 '조용하고 경치 좋은 곳을 찾다 보니'라고 둘러대고, 인내심이 올라가도 그 이상은 명확히 인정하지 않는다",
    ...
    truthBibleFacts: [
      ...
      "21:45 산책로에서 김영훈을 살해함 — 몸싸움은 없었다. 미리 계획한 일이었다 (당신이 저지름)",
