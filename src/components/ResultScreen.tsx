  ...
  return (
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-6 px-4 py-12">
      ...
      {/* Phase 39 — 심문 중엔 아무도 무너지지 않고 최종 지목은 순수 정황 추리로
          ...
          Phase 42 — 숙소 배정표(보드 증거)와 베란다 난간 흔적(3R 증거)을 둘 다
          삭제했다 — 방 번호를 클릭 한 번으로 알려주거나, 아무 것도 안 해도 뜨는
          물증이 사실상 "범인은 이현우"라고 말해주는 것과 다름없다는 지적(사용자).
          이제 방 번호는 오직 심문으로 직접 캐물어야만 알 수 있고, 이 해설도 "가방 속
          등산장비"만 물증으로 언급한다. */}
      <section className="rounded-lg border border-neutral-800 bg-neutral-900/40 p-4">
        <h2 className="mb-2 font-semibold text-neutral-200">사건의 결정적 연결고리</h2>
        <p className="text-sm leading-relaxed text-neutral-300">
          이현우의 방은 박서연의 방 바로 위층이었다. 사건 당일 밤, 산책로에서 흉기를
          휘두른 이현우는 자기 방으로 돌아가 흔적을 지운 뒤, 밤이 깊어 박서연 방이
          잠잠해지자 베란다에서 끈으로 흉기 손잡이의 구멍을 꿰어 아래층 박서연의
          베란다로 내려놓았다 — 바닥에 닿자 한쪽 끝만 당겨 끈을 회수해, 흉기만
          아래층에 남기고 자신은 흔적 없이 빠져나갔다. 두 사람의 방 위치 관계를
          직접 캐물었는지, 그리고 이현우의 가방 속 등산장비(로프·카라비너)까지
          연결해서 생각했는지가 이번 사건의 진짜 관건이었다.
        </p>
      </section>
